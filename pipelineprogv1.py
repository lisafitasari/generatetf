...
def kubeflow_training(
  ...
  if start_step <= 1:
    train_test = dsl.ContainerOp(
      name='train_test',
      image='gcr.io/satu-pama-ai-comex-and-tyre/container-training:latest',
      arguments=[
  ...
  if start_step <= 4:
    measure_map = dsl.ContainerOp(
      name='measure_map',
        image='gcr.io/satu-pama-ai-comex-and-tyre/container-measure-map:latest',
        arguments=[
